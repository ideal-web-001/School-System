...
export class ApiService {
  ...
  get_single_notice(id: any) {
    return this.http.get(this.baseUrl + "notification_view_tbl.php?nid=" + id);
  }
  ...
  delete_librarian(librnid: any) {
    return this.http.delete(this.baseUrl + "delete_librarian.php?librnid=" + librnid)
  }
